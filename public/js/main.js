...
(function($) {
	...
	$(document).ready(function() {
		...
		/* ==================================================
         ...
         ===============================================*/
		// Commented out: This carousel is now handled by the React RelatedUniversity component
		...
		$('.contact-form').each(function() {
			...
			// Only attach the legacy AJAX submit handler if the form has an `action` attribute.
			// React/Formspree forms typically don't use a native `action`, so skip them to avoid
			// hijacking the submission (keep styling via `.contact-form`).
			var actionAttr = formInstance.attr('action');
			if (!actionAttr) {
				return; // skip binding to this form
			}
